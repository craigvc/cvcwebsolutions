...
export default function MobileDevelopmentPageClient() {
  return (
    <main className="min-h-screen bg-gradient-to-br from-gray-900 via-purple-900 to-gray-900">
      ...
      {/* App Types */}
      <section className="py-20 px-4 sm:px-6 lg:px-8" aria-labelledby="app-types-heading">
        <div className="max-w-7xl mx-auto">
          <motion.div
            initial={{ opacity: 0, y: 20 }}
            animate={{ opacity: 1, y: 0 }}
          ...
          >
            <h2 id="app-types-heading" className="text-4xl font-bold text-white text-center mb-12">
        ...
        <div className="max-w-7xl mx-auto">
          ...
          >
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
              <article className="glass p-8 rounded-xl text-center">
                <Zap className="w-12 h-12 text-purple-400 mb-4 mx-auto" aria-hidden="true" />
                <h3 className="text-xl font-semibold text-white mb-3">
                  Native Performance
                </h3>
                <p className="text-gray-300">
              ...
              <article className="glass p-8 rounded-xl text-center">
                <Shield className="w-12 h-12 text-purple-400 mb-4 mx-auto" aria-hidden="true" />
                <h3 className="text-xl font-semibold text-white mb-3">
                  Secure & Scalable
                </h3>
                <p className="text-gray-300">
              ...
              <article className="glass p-8 rounded-xl text-center">
                <Users className="w-12 h-12 text-purple-400 mb-4 mx-auto" aria-hidden="true" />
                <h3 className="text-xl font-semibold text-white mb-3">
        ...
        <div className="max-w-7xl mx-auto">
          ...
          >
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
              ...
              <article className="glass p-8 rounded-xl border-2 border-purple-500">
