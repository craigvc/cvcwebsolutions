    ...
    <main className="min-h-screen bg-gray-900">
      ...
      <section className="py-20 px-4 sm:px-6 lg:px-8" aria-labelledby="services-heading">
        <div className="max-w-7xl mx-auto">
          ...
          >
            <h2 id="services-heading" className="text-4xl font-bold text-white mb-4">What We Do</h2>
              ...
              >
                <Link href={service.href}>
                  <div className="glass rounded-xl p-8 h-full hover:transform hover:scale-105 transition-all duration-300 cursor-pointer relative overflow-hidden">
                    ...
                    <service.icon className={`w-12 h-12 ${service.iconColor} mb-6`} aria-hidden="true" />
                    ...
                    <ul className="space-y-2 mb-6">
                      {service.features.map((feature) => (
                        <li key={feature} className="flex items-center text-gray-400 text-sm">
                          <span className={`${service.iconColor} mr-2`} aria-hidden="true">•</span>
                          {feature}
                        </li>
                      ))}
                    </ul>
      ...
      {/* Process Section */}
      <section className="py-20 px-4 sm:px-6 lg:px-8 bg-gray-800/50" aria-labelledby="process-heading">
        <div className="max-w-7xl mx-auto">
          <motion.div
            initial={{ opacity: 0, y: 20 }}
            whileInView={{ opacity: 1, y: 0 }}
            ...
            className="text-center mb-16"
          >
            <h2 id="process-heading" className="text-4xl font-bold text-white mb-4">Our Process</h2>
            <p className="text-xl text-gray-300">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
            {processSteps.map((step, index) => (
              <motion.article
                ...
                className="text-center"
              >
                <div className="bg-gradient-to-r from-purple-500 to-pink-500 text-white text-2xl font-bold w-16 h-16 rounded-full flex items-center justify-center mx-auto mb-6" aria-hidden="true">
                  {step.step}
                </div>
