...
export default function AboutPageClient() {
  return (
    <main className="min-h-screen bg-gray-900">
      ...
      {/* Our Story */}
      <section className="py-20 px-4 sm:px-6 lg:px-8" aria-labelledby="story-heading">
        <div className="max-w-7xl mx-auto">
          <div className="grid lg:grid-cols-2 gap-16 items-center">
            <motion.div
              ...
              viewport={{ once: true }}
            >
              <h2 id="story-heading" className="text-4xl font-bold text-white mb-6">Our Story</h2>
      ...
      {/* Values */}
      <section className="py-20 px-4 sm:px-6 lg:px-8 bg-gray-800/50" aria-labelledby="values-heading">
        <div className="max-w-7xl mx-auto">
          <motion.div
            initial={{ opacity: 0, y: 20 }}
          ...
          >
            <h2 id="values-heading" className="text-4xl font-bold text-white mb-4">Our Values</h2>
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
            {values.map((value, index) => (
              ...
              >
                <value.icon className="w-12 h-12 text-purple-400 mx-auto mb-4" aria-hidden="true" />
